const TEMP = 13 // temperatura en grados centígrados 
const TIME = 19 // new Date() // fecha y hora
const LOCATION = 'Córdoba'
const DAWN = 7.45 // Horario del amanecer
const SUNSET= 18.50 // Horario anochecer
const SKY = 'despejado' // nublado, despejado, parcial_nublado
...
window.onload = function() {
  ...
  function timer () {
    ...
    degDato.innerHTML = TEMP + 'º'
    timeDato.innerHTML = TIME + ':20 - 16/07/2020'
